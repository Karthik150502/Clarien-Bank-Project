...
import CB_ClarienHTestelp_Link from '@salesforce/label/c.CB_ClarienHTestelp_Link'
...
export default class CBLoginFooter extends NavigationMixin(LightningElement) {
    ...
    */
     ...
     * @return {void} 
    */
    hyperlinkValue = CB_ClarienHTestelp_Link ;
    openHelpPage() {
        console.log('URL....',this.hyperlinkValue);
        this[NavigationMixin.Navigate]({
            type: 'standard__webPage',
            attributes: {
                url: this.hyperlinkValue // URL for Help page
            }
        });      
    }
}