...
import {getSessionStorage, getJsonData, dateToTimestamp } from 'c/cBUtilities';
...
export default class CBResetExpiredPassword extends NavigationMixin(LightningElement) {
    ...
    */
    connectedCallback() {
        ...
        if(getSessionStorage('CBUserName')){
            this.username = getSessionStorage('CBUserName');
        }
        if(getSessionStorage('CBPassword')){
            this.actualOldPassword = getSessionStorage('CBPassword');
        }
    ...
    */
    ...
    //     // Call the checkOldPassword method
    //     // this.checkOldPassword();
    //     // Call the authenticate method with parameters for success GIF and success message
